...
var _user$project$App_Types$updateCotoSelection = F2(
	function (cotoId, selection) {
		return A2(_elm_lang$core$List$member, cotoId, selection) ? A2(
			_elm_lang$core$List$filter,
			function (id) {
				return !_elm_lang$core$Native_Utils.eq(cotoId, id);
			},
...
var _user$project$Components_Timeline_Messages$OpenTraversal = function (a) {
			...
			content: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('coto-content'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$App_Graph$traversed = F3(
	function (index, cotoId, traversal) {
		var steps = (_elm_lang$core$Native_Utils.cmp(index, 0) < 0) ? _elm_lang$core$List$reverse(traversal.steps) : A2(
			_elm_lang$core$List$drop,
			index + 1,
			_elm_lang$core$List$reverse(traversal.steps));
		var _p0 = _elm_lang$core$List$head(steps);
		if (_p0.ctor === 'Nothing') {
			return false;
		} else {
			return _elm_lang$core$Native_Utils.eq(_p0._0, cotoId);
		}
	});
...
var _user$project$App_Graph$getTraversalStarts = function (graph) {
	return A2(
		_elm_lang$core$List$filterMap,
		function (conn) {
			var _p2 = A2(_elm_lang$core$Dict$get, conn.end, graph.cotos);
			if (_p2.ctor === 'Nothing') {
				return _elm_lang$core$Maybe$Nothing;
			} else {
				var _p4 = _p2._0;
				var _p3 = A2(_elm_lang$core$Dict$get, _p4.id, graph.connections);
				if (_p3.ctor === 'Nothing') {
					return _elm_lang$core$Maybe$Nothing;
				} else {
					return _elm_lang$core$Maybe$Just(
						{ctor: '_Tuple2', _0: _p4, _1: _p3._0});
				}
			}
		},
...
var _user$project$App_Graph$connected = F3(
	function (startId, endId, graph) {
		var _p5 = A2(_elm_lang$core$Dict$get, startId, graph.connections);
		if (_p5.ctor === 'Nothing') {
			return false;
		} else {
			return A2(
...
var _user$project$Components_Connections_Messages$CotoClick = function (a) {
					...
					return A3(
						...
						function (maybeValue) {
							...
							if (_p0.ctor === 'Nothing') {
								...
								return _elm_lang$core$Maybe$Just(_p0._0 + count);
							}
						},
						presences);
				}),
					...
					return A3(
						...
						function (maybeValue) {
							...
							if (_p1.ctor === 'Nothing') {
								...
								return _elm_lang$core$Maybe$Just(_p1._0 - count);
							}
						},
						presences);
				}),
		...
		switch (_p2.ctor) {
			...
			case 'ConnectionsMsg':
				...
				if (_p29.ctor === 'CotoClick') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						A2(_user$project$App_Update$clickCoto, _p29._0, newModel),
						{
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App_Messages$ConnectionsMsg, cmd),
							_1: {ctor: '[]'}
						});
				} else {
					return A2(
...
var _user$project$Components_Coto$openTraversalButtonDiv = F3(
	function (buttonClick, maybeCotoId, graph) {
		var _p0 = maybeCotoId;
		if (_p0.ctor === 'Nothing') {
			return A2(
				_elm_lang$html$Html$div,
...
var _user$project$Components_Timeline_View$newPostEditor = F3(
	function (maybeCotonoma, maybeSession, model) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
	...
	function (selection, maybeCotonoma, maybeSession, graph, model) {
		return A2(
			...
			},
			{
				...
				_1: {
					ctor: '::',
					_0: A4(_elm_lang$html$Html_Lazy$lazy3, _user$project$Components_Timeline_View$newPostEditor, maybeCotonoma, maybeSession, model),
					_1: {ctor: '[]'}
				}
			});
	});
...
var _user$project$Components_Connections_View$cotoDiv = F5(
	function (maybeTraversalStep, selection, maybeCotonoma, graph, coto) {
		return A2(
			...
			{
				ctor: '::',
				_0: A4(_user$project$Components_Coto$headerDiv, _user$project$Components_Connections_Messages$CotonomaClick, maybeCotonoma, graph, coto),
				_1: {
					ctor: '::',
						...
						_0: function () {
							...
							if (_p0.ctor === 'Nothing') {
								return A3(
									...
									_user$project$Components_Connections_Messages$OpenTraversal,
	...
	function (maybeTraversalStep, divClass, connections, selection, maybeCotonoma, graph) {
		return A3(
			...
			A2(
				_elm_lang$core$List$map,
				function (conn) {
					var maybeCoto = A2(_elm_lang$core$Dict$get, conn.end, graph.cotos);
					return {
						ctor: '_Tuple2',
						_0: conn.key,
						_1: function () {
								...
								return A2(
									_elm_lang$html$Html$div,
									{
										...
										_0: _elm_lang$html$Html_Attributes$classList(
											{
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'outbound-conn', _1: true},
												_1: {
													ctor: '::',
													_0: {
														ctor: '_Tuple2',
														_0: 'traversed',
														_1: function () {
															var _p2 = maybeTraversalStep;
															if (_p2.ctor === 'Nothing') {
																return false;
															} else {
																return A3(_user$project$App_Graph$traversed, _p2._0._1, _p3.id, _p2._0._0);
															}
														}()
													},
													_1: {ctor: '[]'}
									...
									{
										ctor: '::',
										_0: A5(_user$project$Components_Connections_View$cotoDiv, maybeTraversalStep, selection, maybeCotonoma, graph, _p3),
										_1: {ctor: '[]'}
									});
							}
						}()
...
var _user$project$Components_Connections_View$traversalStepDiv = F5(
	function (traversalStep, cotoId, selection, maybeCotonoma, graph) {
		var _p4 = A2(_elm_lang$core$Dict$get, cotoId, graph.cotos);
		if (_p4.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Nothing;
		} else {
			return _elm_lang$core$Maybe$Just(
					...
					},
					{
						...
						_1: {
							...
							_0: A6(
								...
								traversalStep,
								function () {
									var _p5 = A2(_elm_lang$core$Dict$get, cotoId, graph.connections);
									if (_p5.ctor === 'Nothing') {
										return {ctor: '[]'};
									} else {
										return _p5._0;
...
var _user$project$Components_Connections_View$rootConnections = F3(
	function (selection, maybeCotonoma, graph) {
		return A6(_user$project$Components_Connections_View$connectionsDiv, _elm_lang$core$Maybe$Nothing, 'root-connections', graph.rootConnections, selection, maybeCotonoma, graph);
	});
...
var _user$project$App_View$cotoSelectionTools = function (model) {
	return _elm_lang$core$List$isEmpty(model.cotoSelection) ? A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{ctor: '[]'}) : A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('coto-selection-tools'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_1: {
					...
					},
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('main-timeline'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
				...
				_1: {
					ctor: '::',
					_0: _user$project$App_View$cotoSelectionTools(model),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$map,
