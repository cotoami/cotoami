...
var _user$project$App_Types$Cotonoma = F4(
	function (a, b, c, d) {
		return {id: a, key: b, name: c, cotoId: d};
	});
var _user$project$App_Types$decodeCotonoma = A5(
	_elm_lang$core$Json_Decode$map4,
...
var _user$project$App_Messages$CotonomasToggle = {ctor: 'CotonomasToggle'};
...
var _user$project$App_Commands$fetchCotonomas = A2(
	_elm_lang$http$Http$send,
	_user$project$App_Messages$CotonomasFetched,
	A2(
		_elm_lang$http$Http$get,
		'/api/cotonomas',
	...
	return A2(
		_elm_lang$html$Html$a,
		{
			...
			_0: _elm_lang$html$Html_Attributes$classList(
				{
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'toggle-cotonomas', _1: true},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(_user$project$App_Messages$CotonomasToggle),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: _elm_lang$html$Html$text(
						model.cotonomasOpen ? 'arrow_drop_up' : 'arrow_drop_down'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
