...
var _user$project$Components_CotonomaModal$Model = F3(
	function (a, b, c) {
		return {open: a, name: b, memberEmail: c};
	});
...
var _user$project$Components_CotonomaModal$MemberEmailInput = function (a) {
...
var _user$project$App_Update$update = F2(
	function (msg, model) {
		...
		switch (_p1.ctor) {
			...
			case 'KeyDown':
				var _p3 = _p1._0;
				return (_elm_lang$core$Native_Utils.eq(_p3, _user$project$Keys$ctrl.keyCode) || _elm_lang$core$Native_Utils.eq(_p3, _user$project$Keys$meta.keyCode)) ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{ctrlDown: true}),
				...
				switch (_p16.ctor) {
					...
					case 'CotonomaClick':
						return A2(
							...
							{
								ctor: '::',
								_0: _user$project$App_Commands$fetchCotonoma(_p16._0),
								_1: {ctor: '[]'}
							});
					default:
						return A2(
