		...
		return model.requestDone ? {
			...
			content: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Welcome to Cotoami!'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
			...
			buttons: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Try it out w/o signing up'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
...
var _user$project$Components_Timeline_Model$getCoto = F2(
		...
		var maybePost = _elm_lang$core$List$head(
			A2(
				...
				function (post) {
					return _elm_lang$core$Native_Utils.eq(
						post.cotoId,
						_elm_lang$core$Maybe$Just(cotoId));
				},
				model.posts));
		var _p4 = maybePost;
		if (_p4.ctor === 'Nothing') {
			...
			return _user$project$Components_Timeline_Model$toCoto(_p4._0);
		}
	});
...
var _user$project$App_Messages$CotonomaPresenceDiff = function (a) {
	return {ctor: 'CotonomaPresenceDiff', _0: a};
};
var _user$project$App_Messages$CotonomaPresenceState = function (a) {
	return {ctor: 'CotonomaPresenceState', _0: a};
};
			...
			function (entry) {
				return {
					...
					_1: _elm_lang$core$List$length(
						_elm_lang$core$Tuple$second(entry))
				};
			},
			entries));
};
...
var _user$project$App_Channels$decodePresenceDiff = function (payload) {
	...
	if (_p1.ctor === 'Ok') {
		...
		return {ctor: '_Tuple2', _0: _elm_lang$core$Dict$empty, _1: _elm_lang$core$Dict$empty};
	}
};
var _user$project$App_Channels$cotonomaChannel = function (key) {
	return A3(
		...
		'presence_diff',
		function (payload) {
			return _user$project$App_Messages$CotonomaPresenceDiff(payload);
		},
		A3(
			_saschatimme$elm_phoenix$Phoenix_Channel$on,
			'presence_state',
			function (payload) {
				return _user$project$App_Messages$CotonomaPresenceState(payload);
			},
			A3(
				_saschatimme$elm_phoenix$Phoenix_Channel$on,
				'post',
...
var _user$project$Components_Connections_Model$Connection = F3(
	function (a, b, c) {
		return {id: a, key: b, end: c};
	});
...
var _user$project$App_Model$isPresent = F2(
	function (amishiId, memberPresences) {
		return _elm_lang$core$Native_Utils.cmp(
			A2(
				_elm_lang$core$Maybe$withDefault,
				0,
				A2(_elm_lang$core$Dict$get, amishiId, memberPresences)),
			0) > 0;
	});
var _user$project$App_Model$openSigninModal = function (model) {
...
var _user$project$App_Model$initModel = F2(
	function (seed, route) {
		...
		return {
			...
			members: {ctor: '[]'},
			memberPresences: _elm_lang$core$Dict$empty,
																	...
																	return function (r) {
																		return function (s) {
																			return function (t) {
																				return function (u) {
																					return function (v) {
																						return {clientId: a, route: b, ctrlDown: c, navigationToggled: d, navigationOpen: e, session: f, cotonoma: g, members: h, memberPresences: i, confirmModal: j, signinModal: k, profileModal: l, cotoModal: m, recentCotonomas: n, cotonomasLoading: o, subCotonomas: p, timeline: q, connectMode: r, cotonomaModal: s, stockToggled: t, stockOpen: u, connections: v};
																					};
																				};
																			};
																		};
...
var _user$project$App_Update$updateConnectMode = F2(
	function (clickedId, maybeConnectMode) {
		var _p0 = maybeConnectMode;
		if (_p0.ctor === 'Nothing') {
			return _elm_lang$core$Maybe$Just(
				A2(
					_user$project$App_Types$ConnectMode,
					clickedId,
					{ctor: '[]'}));
		} else {
			var _p1 = _p0._0;
...
var _user$project$App_Update$applyPresenceDiff = F2(
	function (diff, presences) {
		var presencesJoined = A3(
			_elm_lang$core$Dict$foldl,
			F3(
				function (amishiId, count, presences) {
					return A3(
						_elm_lang$core$Dict$update,
						amishiId,
						function (maybeValue) {
							var _p2 = maybeValue;
							if (_p2.ctor === 'Nothing') {
								return _elm_lang$core$Maybe$Just(count);
							} else {
								return _elm_lang$core$Maybe$Just(_p2._0 + count);
							}
						},
						presences);
				}),
			presences,
			_elm_lang$core$Tuple$first(diff));
		return A3(
			_elm_lang$core$Dict$foldl,
			F3(
				function (amishiId, count, presences) {
					return A3(
						...
						function (maybeValue) {
							...
							if (_p3.ctor === 'Nothing') {
								...
								return _elm_lang$core$Maybe$Just(_p3._0 - count);
							}
						},
						presences);
				}),
...
var _user$project$App_Update$stock = F2(
	function (connectMode, model) {
		var newConnections = function () {
			var _p4 = A2(_user$project$App_Model$getCoto, connectMode.baseCotoId, model);
			if (_p4.ctor === 'Nothing') {
				return model.connections;
			} else {
				return A2(_user$project$Components_Connections_Model$addRootConnection, _p4._0, model.connections);
			}
		}();
		return _elm_lang$core$Native_Utils.update(
			model,
	...
	function (msg, model) {
		...
		switch (_p5.ctor) {
			...
			case 'OnLocationChange':
				var newRoute = _user$project$App_Routing$parseLocation(_p5._0);
				...
				switch (_p6.ctor) {
					...
					case 'CotonomaRoute':
						return A2(_user$project$App_Update$loadCotonoma, _p6._0, newModel);
					default:
				...
				if (_p5._0.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								session: _elm_lang$core$Maybe$Just(_p5._0._0)
							}),
						{ctor: '[]'});
				} else {
					var _p7 = _p5._0._0;
					if (_p7.ctor === 'BadStatus') {
						return _elm_lang$core$Native_Utils.eq(_p7._0.status.code, 404) ? A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'RecentCotonomasFetched':
				if (_p5._0.ctor === 'Ok') {
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{recentCotonomas: _p5._0._0, cotonomasLoading: false}),
						{ctor: '[]'});
				} else {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'CotonomaFetched':
				if (_p5._0.ctor === 'Ok') {
					...
					var _p8 = A5(
						...
						model.ctrlDown,
						_user$project$Components_Timeline_Messages$PostsFetched(
							_elm_lang$core$Result$Ok(_p5._0._0._2)),
						model.timeline);
					var timeline = _p8._0;
					var cmd = _p8._1;
					return A2(
						...
						_elm_lang$core$Native_Utils.update(
							model,
							{
								cotonoma: _elm_lang$core$Maybe$Just(_p9),
								members: _p5._0._0._1,
								navigationOpen: false,
								timeline: timeline
							}),
						{
			...
			case 'KeyDown':
				var _p10 = _p5._0;
				return (_elm_lang$core$Native_Utils.eq(_p10, _user$project$Keys$ctrl.keyCode) || _elm_lang$core$Native_Utils.eq(_p10, _user$project$Keys$meta.keyCode)) ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{ctrlDown: true}),
			...
			case 'KeyUp':
				var _p11 = _p5._0;
				return (_elm_lang$core$Native_Utils.eq(_p11, _user$project$Keys$ctrl.keyCode) || _elm_lang$core$Native_Utils.eq(_p11, _user$project$Keys$meta.keyCode)) ? A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{ctrlDown: false}),
			...
			case 'ConfirmModalMsg':
				var _p12 = A2(_user$project$Components_ConfirmModal_Update$update, _p5._0, model.confirmModal);
				var confirmModal = _p12._0;
				var cmd = _p12._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
			...
			case 'OpenSigninModal':
				return A2(
					...
					{ctor: '[]'});
			case 'SigninModalMsg':
				var _p13 = A2(_user$project$Components_SigninModal$update, _p5._0, model.signinModal);
				var signinModal = _p13._0;
				var cmd = _p13._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
			...
			case 'ProfileModalMsg':
				var _p14 = A2(_user$project$Components_ProfileModal$update, _p5._0, model.profileModal);
				var profileModal = _p14._0;
				var cmd = _p14._1;
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
			...
			case 'CotoModalMsg':
				...
				var _p15 = A2(_user$project$Components_CotoModal$update, _p21, model.cotoModal);
					...
					case 'Delete':
						...
						return A2(
									...
									timeline: _elm_lang$core$Native_Utils.update(
										timeline,
										{
											posts: A2(
												_elm_lang$core$List$map,
												function (post) {
													return A2(_user$project$Components_Timeline_Model$isSelfOrPostedIn, _p20, post) ? _elm_lang$core$Native_Utils.update(
														post,
								...
								}),
							{
								...
								_1: {
									ctor: '::',
									_0: _user$project$App_Commands$deleteCoto(_p20.id),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$core$Task$perform,
											function (_p18) {
												return _user$project$App_Messages$DeleteCoto(_p20);
											},
											A2(
												_elm_lang$core$Task$andThen,
												function (_p19) {
			...
			case 'TimelineMsg':
				...
				var _p22 = A5(_user$project$Components_Timeline_Update$update, model.clientId, model.cotonoma, model.ctrlDown, _p24, model.timeline);
				var timeline = _p22._0;
				var cmd = _p22._1;
				var _p23 = _p24;
				switch (_p23.ctor) {
					case 'PostClick':
						return A2(
							...
							_elm_lang$core$Native_Utils.update(
								...
								{
									timeline: timeline,
									connectMode: A2(_user$project$App_Update$updateConnectMode, _p23._0, model.connectMode)
								}),
							{
								ctor: '::',
								_0: A2(_elm_lang$core$Platform_Cmd$map, _user$project$App_Messages$TimelineMsg, cmd),
							...
							_elm_lang$core$Native_Utils.update(
								model,
								{
									...
									cotoModal: _elm_lang$core$Native_Utils.update(
										...
										{
											open: true,
											coto: _user$project$Components_Timeline_Model$toCoto(_p23._0)
										})
								}),
							{
								ctor: '::',
					...
					case 'CotonomaClick':
						return A2(_user$project$App_Update$changeLocationToCotonoma, _p23._0, model);
					case 'CotonomaPushed':
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
							...
							timeline: _elm_lang$core$Native_Utils.update(
								timeline,
								{
									posts: A2(
										_elm_lang$core$List$filter,
										function (post) {
											return !A2(_user$project$Components_Timeline_Model$isSelfOrPostedIn, _p25, post);
										},
										posts)
								})
						}),
			...
			case 'CotonomaModalMsg':
				...
				if (_p27.ctor === 'Nothing') {
					...
					var _p28 = A6(_user$project$Components_CotonomaModal_Update$update, model.clientId, _p27._0, model.cotonoma, _p30, model.timeline, model.cotonomaModal);
					var cotonomaModal = _p28._0;
					var timeline = _p28._1;
					var cmd = _p28._2;
					var newModel = _elm_lang$core$Native_Utils.update(
						model,
					...
					var _p29 = _p30;
					if ((_p29.ctor === 'Posted') && (_p29._0.ctor === 'Ok')) {
						return A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
							_elm_lang$core$Native_Utils.update(
								newModel,
			...
			case 'CotonomaClick':
				return A2(_user$project$App_Update$changeLocationToCotonoma, _p5._0, model);
			case 'CotonomaPresenceState':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							memberPresences: _user$project$App_Channels$decodePresenceState(_p5._0)
						}),
					{ctor: '[]'});
			case 'CotonomaPresenceDiff':
				var presenceDiff = _user$project$App_Channels$decodePresenceDiff(_p5._0);
				var newMemberPresences = A2(_user$project$App_Update$applyPresenceDiff, presenceDiff, model.memberPresences);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{memberPresences: newMemberPresences}),
					{ctor: '[]'});
			case 'ConnectionsMsg':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			default:
				...
				if (_p31.ctor === 'Nothing') {
					...
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						A2(_user$project$App_Update$stock, _p31._0, model),
						{ctor: '[]'});
				}
		}
	});
											...
											_1: {
												...
												_1: {
													...
													_0: {
														ctor: '_Tuple2',
														_0: 'online',
														_1: A2(_user$project$App_Model$isPresent, _p1.id, memberPresences)
													},
													_1: {ctor: '[]'}
												}
											}
												...
												_0: _elm_lang$html$Html_Attributes$classList(
													{
														...
														_1: {
															...
															_0: {
																ctor: '_Tuple2',
																_0: 'online',
																_1: A2(_user$project$App_Model$isPresent, member.id, memberPresences)
															},
															_1: {ctor: '[]'}
														}
													}),
...
var _user$project$Components_Timeline_View$timelineDiv = F4(
	function (maybeConnectMode, maybeCotonoma, maybeSession, model) {
		return A3(
			_elm_lang$html$Html_Keyed$node,
			'div',
			{
			...
			A2(
				...
				function (post) {
					return {
						...
						_1: A4(_user$project$Components_Timeline_View$postDiv, maybeConnectMode, maybeCotonoma, maybeSession, post)
					};
				},
...
var _user$project$Components_Timeline_View$view = F4(
	function (maybeConnectMode, maybeCotonoma, maybeSession, model) {
		return A2(
			...
			{
				ctor: '::',
				_0: A4(_user$project$Components_Timeline_View$timelineDiv, maybeConnectMode, maybeCotonoma, maybeSession, model),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('column-traversal'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('connections-column'),
							_1: {ctor: '[]'}
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('sub-cotos'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Kubernetes is an open-source platform for automating deployment, scaling, and operations of application containers across clusters of hosts, providing container-centric infrastructure.'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}),
													...
													_0: A2(
														...
														},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('The New Way is to deploy containers based on operating-system-level virtualization rather than hardware virtualization. These containers are isolated from each other and from the host: they have their own filesystems, they can’t see each others’ processes, and their computational resource usage can be bounded. They are easier to build than VMs, and because they are decoupled from the underlying infrastructure and from the host filesystem, they are portable across clouds and OS distributions.'),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}),
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										A4(_user$project$Components_Timeline_View$view, model.connectMode, model.cotonoma, model.session, model.timeline)),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
